...
def resnet18_cbam(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['resnet18']) # type: ignore
...
def resnet34_cbam(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['resnet34']) # type: ignore
        now_state_dict        = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict)
    return model
...
def resnet50_cbam(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['resnet50']) # type: ignore
        now_state_dict        = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict)
    return model
...
def resnet101_cbam(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['resnet101']) # type: ignore
        now_state_dict        = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict)
    return model
...
def resnet152_cbam(pretrained=False, **kwargs):
    ...
    if pretrained:
        pretrained_state_dict = model_zoo.load_url(model_urls['resnet152']) # type: ignore
        now_state_dict        = model.state_dict()
        now_state_dict.update(pretrained_state_dict)
        model.load_state_dict(now_state_dict)
    return model